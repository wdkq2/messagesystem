...
상단의 **저장 목록** 버튼을 누르면 팝업 창으로 저장된 멘트 목록을 볼 수 있으며, 기본 이름(`저장-1`, `저장-2` …)을 클릭하여 수정할 수 있습니다. 검색창에 이름을 입력해 원하는 멘트를 빠르게 찾을 수도 있습니다. 팝업 우측 상단의 **닫기** 버튼을 누르면 목록 창이 닫히고 원래 화면으로 돌아옵니다.
